...
8. **QUINTE boundary.** MAGI may appear inside QUINTE only as R3 KANSA B; it never substitutes for R1/R2 debate parties.
...
- [../specs/PROTOCOL.md](../specs/PROTOCOL.md) — v1.7 canonical spec
